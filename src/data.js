...
export const reviews = [
  {
    ...
    comment:
      'So delighted that i had the chance to seat at the front roow for thie event, awesome stuff.'
  },
  {
    id: 2,
    name: 'Mike',
    ...
    comment:
      'Awesome stuff, when is the next event i need to set my reminder.'
  },
  {
    id: 3,
    name: 'Sofia',
